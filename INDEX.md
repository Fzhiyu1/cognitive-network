---
generated: 2026-07-30T21:53:11+0800
...
- [[知道与推测不分]] :: LLM 输出"知道"与"猜"走同一条采样通路，无元监控信号；模型越强伪装越深，校准不可外包给 AI。 :: in=22 out=8 :: #AI #认知科学 #哲学 :: cluster=C-RL+LLM双系统
...
- [[适应度幻觉]] :: 评测方式与真实目标错位时，进化产出高分但无效的解；meomory v4、MTV ARM、kaiwu 暖启动是三种子型 :: in=31 out=10 :: #AI #认知科学 #优化 :: cluster=C-适应度幻觉
...
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=36 out=12 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
...
- [[判断力的有效梯度]] :: 判断动作只有经过事前预测、外部结果、误差归因并改变后续行为，才会转化为能力增长。 :: in=10 out=9 :: #AI #方法论 #认知科学 :: cluster=C-超级个体公式
...
- [[共识的四重分歧]] :: 价值成立而市场不动时，卡点必在感知、想象、场景、利益相关人四者之一，逐层排查而非归因于产品不够好。 :: in=6 out=5 :: #方法论 #商业 :: cluster=C-共识的四重分歧
...
- [[借来的结论]] :: 结论是压缩掉纹路的叶子剪影；理解不可传递只能重新推导，老生常谈感正是持有叶子却没走过推导树的落差 :: in=5 out=8 :: #认知科学 #哲学 #方法论 :: cluster=C-描述即污染
- [[默认值运气]] :: 决策者读不懂底层公式时，参数默认值是否碰巧正确决定整个研究方向的生死 :: in=7 out=3 :: #方法论 #AI :: cluster=C-适应度幻觉
- [[商业闭环三要素]] :: 价值-共识-模式构成商业最小闭环，努力没换来回报时逐环排查是哪一环没打通，而非笼统归因于运气或努力不足。 :: in=5 out=5 :: #方法论 #商业 :: cluster=C-共识的四重分歧
- [[拟合值与拟合原理的分离]] :: LLM 输出正确的值和合理的解释是两次独立采样，能事后解释不等于能提前预测 :: in=10 out=4 :: #AI #认知科学 :: cluster=C-适应度幻觉
- [[应然与实然]] :: 应然是脑中该有的样子，实然是实际的样子；精英困境在于用抽象框架推导应然并把推导当已知，是 [[知道与推测不分]] 的商业版本。 :: in=4 out=4 :: #方法论 #认知科学 #商业 :: cluster=C-共识的四重分歧
...
- [[判断力位]] :: atlas 把"人的判断"挖成搜索循环里不可跳过的槽位；AI 能坐进去但只是镜子，人坐进去才是成长入口。 :: in=9 out=10 :: #AI #工程 #方法论 :: cluster=C-描述即污染
- [[万物皆反馈环]] :: 进化、RL、学习、市场都是同一种尝试-反馈-调整结构，反馈环指向自身就成为奇异环 :: in=9 out=10 :: #哲学 #AI #认知科学 :: cluster=C-适应度幻觉
- [[压力-搜索-产物链]] :: 分子→生命→大脑→AI→模拟宇宙：每层由特定压力驱动搜索，产物成为下层基质，最后两步压力相同（预测）只换基质。 :: in=5 out=10 :: #AI #认知科学 #哲学 :: cluster=C-适应度幻觉
...
- [[产品价值三层]] :: 产品价值=功能+情绪+资产三层叠加，创新的实质是重排这三层的组合而非发明新品类。 :: in=3 out=3 :: #方法论 #商业 :: cluster=C-共识的四重分歧
...
- [[产品场景匹配]] :: PMF 之前先有 PSF——"市场"颗粒度太粗，产品要先在一个真实具体的场景里活下来才谈得上市场。 :: in=2 out=3 :: #方法论 #商业 :: cluster=C-共识的四重分歧
...
- [[预测极限即模拟]] :: 由 Solomonoff 归纳，最优预测渐近收敛为对数据源的最短描述，因此被无限预测压力推动的系统必然渐近建出一个完整宇宙模拟。 :: in=3 out=7 :: #AI #哲学 :: cluster=C-适应度幻觉
...
- [[判断力位全成本]] :: AI 替代人的真实账目 = token 成本 + 判断力位维护成本；后者延迟、不可见、累积，被系统性低估。 :: in=3 out=10 :: #AI #方法论 #哲学 :: cluster=C-超级个体公式
...
- [[借来的权威]] :: AI 监控/前额叶层即使造出来，否决权也是对训练标签的模仿，不是对真实代价的承担——没有 stakes 锚就只有表演性权威。 :: in=5 out=8 :: #AI #认知科学 #哲学 :: cluster=C-适应度幻觉
...
- [[单向决策系统]] :: LLM 是只能向前的决策者；reverse 不是缺失功能，而是动作本身在其物理结构里没有对应物。 :: in=3 out=8 :: #AI #认知科学 :: cluster=C-适应度幻觉
...
- [[2026-05-13-AI决策的反向能力]] :: 从"AI 能不能做决策"出发，澄清反向能力作为操作本身不存在；推出窄域可造/开放域造不出的领域分化、判断力位的全成本、期权式外推等多层结构。 :: in=5 out=15 :: #AI #认知科学 #哲学 :: cluster=C-适应度幻觉
- [[2026-07-30-每天命令AI究竟在训练什么]] :: 从命令、阅读和验收三种日常动作，推导出人真正训练的是世界模型、调度策略与奖励模型。 :: in=1 out=6 :: #AI #方法论 #认知科学 :: cluster=C-超级个体公式
...
- [[真需求 - 梁宁]] :: 梁宁把商业拆成价值-共识-模式的极简闭环，核心断言是价值由买方需求定义、共识需逐层消解分歧、模式决定谁能活下来。 :: in=5 out=9 :: #方法论 #商业 :: cluster=C-共识的四重分歧
