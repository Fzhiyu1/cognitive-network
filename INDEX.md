---
generated: 2026-05-13T09:28:12+0800
...
- [[多层有损压缩]] :: 信号穿过多层表征会逐层降维；意识→思维→语言→文本→模型只是一个实例；遗忘是压缩副产物。 :: in=58 out=15 :: #AI #哲学 :: cluster=C-多层有损压缩
...
- [[知道与推测不分]] :: LLM 输出"知道"与"猜"走同一条采样通路，无元监控信号；模型越强伪装越深，校准不可外包给 AI。 :: in=17 out=6 :: #AI #认知科学 #哲学 :: cluster=C-RL+LLM双系统
...
- [[描述即污染]] :: 文本进入上下文就改变 LLM 概率分布，skill 描述哪怕从不调用也在塑造输出风格。 :: in=19 out=4 :: #AI #认知科学 :: cluster=C-描述即污染
- [[超级个体公式]] :: 真实经验 × AI 交互质量 × 元认知精度的乘法结构，任一项为零则认知升级幅度归零。 :: in=10 out=6 :: #认知科学 #方法论 :: cluster=C-RL+LLM双系统
...
- [[预测分层跃迁]] :: 同一套预测机制在复杂度增加中逐层长出模型、理解、自我与意识。 :: in=5 out=6 :: #AI #认知科学 #哲学 :: cluster=C-可观测性
...
- [[适应度幻觉]] :: 评测方式与真实目标错位时，进化产出高分但无效的解；meomory v4、MTV ARM、kaiwu 暖启动是三种子型 :: in=26 out=8 :: #AI #认知科学 #优化 :: cluster=C-适应度幻觉
...
- [[研究者过拟合]] :: 研究者被早期高分锚定后失去对评测方式本身的质疑能力，AI 研究者也会犯同样的认知偏差 :: in=17 out=6 :: #认知科学 #元认知 :: cluster=C-适应度幻觉
...
- [[研究核与投射]] :: 项目数 ≠ 方向数；13 个散乱仓库可能是 3-4 个研究核的不同投射，显性化核能让决策带宽降到 1/3。 :: in=4 out=9 :: #方法论 #认知科学 #AI :: cluster=C-RL+LLM双系统
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=29 out=9 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
- [[AI镜像效应]] :: AI 产出是用户自身想法的反射而非外部异物，长期只消费 AI 等于自我对话导致认知耗尽。 :: in=21 out=8 :: #AI #哲学 #认知科学 :: cluster=C-描述即污染
...
- [[评估时间尺度错配]] :: 评测时长与改动生效时长不匹配会产生相反结论，短期测适应速度，长期测稳态质量 :: in=4 out=4 :: #AI #方法论 #实验 :: cluster=C-适应度幻觉
...
- [[判断力位]] :: atlas 把"人的判断"挖成搜索循环里不可跳过的槽位；AI 能坐进去但只是镜子，人坐进去才是成长入口。 :: in=5 out=9 :: #AI #工程 #方法论 :: cluster=C-描述即污染
...
- [[借来的权威]] :: AI 监控/前额叶层即使造出来，否决权也是对训练标签的模仿，不是对真实代价的承担——没有 stakes 锚就只有表演性权威。 :: in=3 out=7 :: #AI #认知科学 #哲学 :: cluster=C-描述即污染
- [[提示词进化实验]] :: GA 进化 Judge prompt 从 28.9% 到 90.9%，验证措辞影响巨大且评测目标比进化策略更重要 :: in=1 out=3 :: #AI #优化 #实验 :: cluster=C-适应度幻觉
- [[期权式外推]] :: 市场不需要相信 AI 能做开放域决策，只需要给"万一能"留非零概率乘 TAM——结构上不可证伪的外推。 :: in=2 out=9 :: #AI #方法论 #哲学 :: cluster=C-适应度幻觉
...
- [[涌现的解剖：meomory诞生考古]] :: 用git考古重建2026-03-15 meomory诞生47分钟，证伪单方涌现，提出4方接力模型 :: in=8 out=16 :: #AI #认知科学 #方法论 :: cluster=C-多层有损压缩
- [[AI镜像陷阱：当创造者只消费AI的产出]] :: 从 vibe coding 上瘾追到知识库自审计，发现回音室与模型溶解共享同一结构：异分布信号比例。 :: in=5 out=8 :: #AI #哲学 #认知科学 #方法论 :: cluster=C-RL+LLM双系统
