...
- [[多层有损压缩]] :: 信号穿过多层表征会逐层降维；意识→思维→语言→文本→模型只是一个实例；遗忘是压缩副产物。 :: in=55 out=15 :: #AI #哲学 :: cluster=C-多层有损压缩
...
- [[工程惯性覆盖]] :: LLM 生成时训练数据中的高频工程模式（如 TTL）会盖过当前上下文中已建立的理论框架 :: in=8 out=5 :: #AI #认知科学 #方法论 :: cluster=C-适应度幻觉
- [[研究者过拟合]] :: 研究者被早期高分锚定后失去对评测方式本身的质疑能力，AI 研究者也会犯同样的认知偏差 :: in=15 out=6 :: #认知科学 #元认知 :: cluster=C-适应度幻觉
- [[知识库元认知]] :: 输出驱动的认知网络——只收录"我的思考"，链接密度 / 提炼转化率 / 脱稿讲述能力是健康指标。 :: in=8 out=8 :: #方法论 :: cluster=C-多层有损压缩
- [[研究核与投射]] :: 项目数 ≠ 方向数；13 个散乱仓库可能是 3-4 个研究核的不同投射，显性化核能让决策带宽降到 1/3。 :: in=4 out=9 :: #方法论 #认知科学 #AI :: cluster=C-描述即污染
- [[进化突破人类认知偏见]] :: 进化没有"之前试过不行"的记忆包袱，能找到人类因锚定/控制变量法而排除的有效方案 :: in=10 out=8 :: #AI #认知科学 #优化 :: cluster=C-适应度幻觉
- [[AI镜像效应]] :: AI 产出是用户自身想法的反射而非外部异物，长期只消费 AI 等于自我对话导致认知耗尽。 :: in=18 out=8 :: #AI #哲学 #认知科学 :: cluster=C-描述即污染
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=25 out=9 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
...
- [[失败可见性]] :: 元认知系统的成功标准——不是 recall 准确率，而是让"我刚才在幻觉/记错"这件事变成可观测、可追问、可修正的。 :: in=9 out=11 :: #AI #认知科学 #工程 :: cluster=C-描述即污染
...
- [[判断力位]] :: atlas 把"人的判断"挖成搜索循环里不可跳过的槽位；AI 能坐进去但只是镜子，人坐进去才是成长入口。 :: in=3 out=8 :: #AI #工程 #方法论 :: cluster=C-描述即污染
