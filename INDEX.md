---
generated: 2026-05-02T22:02:15+0800
...
- [[多层有损压缩]] :: 意识到文本经历多层压缩，大模型只是影子的影子；遗忘是压缩代价，不是独立模块。 :: in=49 out=10 :: #AI #哲学 :: cluster=C-多层有损压缩
...
- [[描述即污染]] :: 文本进入上下文就改变 LLM 概率分布，skill 描述哪怕从不调用也在塑造输出风格。 :: in=15 out=4 :: #AI #认知科学 :: cluster=C-描述即污染
- [[前意识激活层]] :: 在 LLM 之前放一个它看不见的匹配层，让记忆"自动浮现"而非主动检索——区分记忆与图书馆的关键。 :: in=17 out=8 :: #AI #认知科学 #工程 :: cluster=C-多层有损压缩
...
- [[SAE特征激活观测实验]] :: 用稀疏自编码器观测开源模型内部特征激活，验证"描述即污染"的神经级机制 :: in=0 out=5 :: #AI #实验 #认知科学 :: cluster=C-描述即污染
