...
- [[多层有损压缩]] :: 信号穿过多层表征会逐层降维；意识→思维→语言→文本→模型只是一个实例；遗忘是压缩副产物。 :: in=57 out=15 :: #AI #哲学 :: cluster=C-多层有损压缩
...
- [[知道与推测不分]] :: LLM 输出"知道"与"猜"走同一条采样通路，无元监控信号；模型越强伪装越深，校准不可外包给 AI。 :: in=16 out=6 :: #AI #认知科学 #哲学 :: cluster=C-RL+LLM双系统
...
- [[没有前额叶的皮层]] :: LLM 保留系统2执行能力却丢失自我监控，导致 [[知道与推测不分]]，与脑干缺失是两个独立的结构性缺陷。 :: in=14 out=6 :: #AI #认知科学 :: cluster=C-RL+LLM双系统
...
- [[适应度幻觉]] :: 评测方式与真实目标错位时，进化产出高分但无效的解；meomory v4、MTV ARM、kaiwu 暖启动是三种子型 :: in=25 out=8 :: #AI #认知科学 #优化 :: cluster=C-适应度幻觉
...
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=28 out=9 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
- [[AI镜像效应]] :: AI 产出是用户自身想法的反射而非外部异物，长期只消费 AI 等于自我对话导致认知耗尽。 :: in=20 out=8 :: #AI #哲学 #认知科学 :: cluster=C-描述即污染
...
- [[失败可见性]] :: 元认知系统的成功标准——不是 recall 准确率，而是让"我刚才在幻觉/记错"这件事变成可观测、可追问、可修正的。 :: in=12 out=11 :: #AI #认知科学 #工程 :: cluster=C-描述即污染
...
- [[评估时间尺度错配]] :: 评测时长与改动生效时长不匹配会产生相反结论，短期测适应速度，长期测稳态质量 :: in=3 out=4 :: #AI #方法论 #实验 :: cluster=C-适应度幻觉
...
- [[判断力位]] :: atlas 把"人的判断"挖成搜索循环里不可跳过的槽位；AI 能坐进去但只是镜子，人坐进去才是成长入口。 :: in=4 out=8 :: #AI #工程 #方法论 :: cluster=C-描述即污染
...
- [[单向决策系统]] :: LLM 是只能向前的决策者；reverse 不是缺失功能，而是动作本身在其物理结构里没有对应物。 :: in=2 out=8 :: #AI #认知科学 :: cluster=C-适应度幻觉
- [[借来的权威]] :: AI 监控/前额叶层即使造出来，否决权也是对训练标签的模仿，不是对真实代价的承担——没有 stakes 锚就只有表演性权威。 :: in=2 out=7 :: #AI #认知科学 #哲学 :: cluster=C-适应度幻觉
- [[潜伏层]] :: substrate 双层结构里"已存在但未卡片化"的层（PDF/长文/对话/脑中复现），是[[显式化爆发]]的原料 :: in=2 out=11 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
- [[期权式外推]] :: 市场不需要相信 AI 能做开放域决策，只需要给"万一能"留非零概率乘 TAM——结构上不可证伪的外推。 :: in=1 out=8 :: #AI #方法论 #哲学 :: cluster=C-适应度幻觉
...
- [[2026-05-13-AI决策的反向能力]] :: 从"AI 能不能做决策"出发，澄清反向能力作为操作本身不存在；推出窄域可造/开放域造不出的领域分化、判断力位的全成本、期权式外推等多层结构。 :: in=3 out=15 :: #AI #认知科学 #哲学 :: cluster=C-适应度幻觉
