...
- [[多层有损压缩]] :: 信号穿过多层表征会逐层降维；意识→思维→语言→文本→模型只是一个实例；遗忘是压缩副产物。 :: in=59 out=15 :: #AI #哲学 :: cluster=C-多层有损压缩
...
- [[知道与推测不分]] :: LLM 输出"知道"与"猜"走同一条采样通路，无元监控信号；模型越强伪装越深，校准不可外包给 AI。 :: in=18 out=6 :: #AI #认知科学 #哲学 :: cluster=C-知道与推测不分
...
- [[描述即污染]] :: 文本进入上下文就改变 LLM 概率分布，skill 描述哪怕从不调用也在塑造输出风格。 :: in=19 out=4 :: #AI #认知科学 :: cluster=C-知道与推测不分
...
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=31 out=9 :: #AI #认知科学 #方法论 :: cluster=C-校准的不可外包性
...
- [[研究核与投射]] :: 项目数 ≠ 方向数；13 个散乱仓库可能是 3-4 个研究核的不同投射，显性化核能让决策带宽降到 1/3。 :: in=5 out=9 :: #方法论 #认知科学 #AI :: cluster=C-校准的不可外包性
...
- [[判断力位]] :: atlas 把"人的判断"挖成搜索循环里不可跳过的槽位；AI 能坐进去但只是镜子，人坐进去才是成长入口。 :: in=5 out=9 :: #AI #工程 #方法论 :: cluster=C-知道与推测不分
...
- [[借来的权威]] :: AI 监控/前额叶层即使造出来，否决权也是对训练标签的模仿，不是对真实代价的承担——没有 stakes 锚就只有表演性权威。 :: in=4 out=7 :: #AI #认知科学 #哲学 :: cluster=C-知道与推测不分
...
- [[金融钟先行]] :: AI 周期里金融层的"误外推暴露"先于认知层；股价坍缩 ≠ AI 不行了，AI 出错 ≠ 股价该崩。 :: in=1 out=7 :: #AI #方法论 :: cluster=C-知道与推测不分
