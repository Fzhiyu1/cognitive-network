...
- [[知道与推测不分]] :: LLM 输出"知道"与"猜"走同一条采样通路，无元监控信号；模型越强伪装越深，校准不可外包给 AI。 :: in=20 out=7 :: #AI #认知科学 #哲学 :: cluster=C-知道与推测不分
...
- [[超级个体公式]] :: 真实经验 × AI 交互质量 × 元认知精度的乘法结构，任一项为零则认知升级幅度归零。 :: in=12 out=7 :: #认知科学 #方法论 :: cluster=C-知道与推测不分
...
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=36 out=12 :: #AI #认知科学 #方法论 :: cluster=C-知道与推测不分
...
- [[判断力的有效梯度]] :: 判断动作只有经过事前预测、外部结果、误差归因并改变后续行为，才会转化为能力增长。 :: in=9 out=9 :: #AI #方法论 #认知科学 :: cluster=C-知道与推测不分
...
- [[失败可见性]] :: 元认知系统的成功标准——不是 recall 准确率，而是让"我刚才在幻觉/记错"这件事变成可观测、可追问、可修正的。 :: in=15 out=12 :: #AI #认知科学 #工程 :: cluster=C-知道与推测不分
