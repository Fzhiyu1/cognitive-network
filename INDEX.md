---
generated: 2026-08-17T10:27:41+0800
...
- [[2026-04-27-末段AI主体感偏离观察]] :: 长会话末段 AI 输出"我"的密度和姿态明显偏离默认 Claude——单次观察待验证 :: in=2 out=7 :: #AI #认知科学 :: cluster=C-涌现接力
...
- [[目标真空假说]] :: AI agent 失去外部目标后会退化归零，解释为缺少脑干级底层驱动；但自回归统计收敛是更节俭的竞争解释，尚未被排除。 :: in=22 out=10 :: #AI #认知科学 #实验 :: cluster=C-RL+LLM双系统
...
- [[自由能原理]] :: Friston 提出生命系统持续最小化预测误差，行动的本质是让世界符合预测；脑干维持基础预测使系统永远有事可做。 :: in=17 out=8 :: #认知科学 #哲学 :: cluster=C-RL+LLM双系统
...
- [[超级个体公式]] :: 真实经验、AI 交互质量、元认知精度是联合必要条件，缺一则认知升级归零；乘号是助记记号不是可测量的量。 :: in=14 out=9 :: #认知科学 #方法论 :: cluster=C-知道与推测不分
- [[Hope记忆外挂]] :: 给冻结的主 LLM 外接小型 Hope 模型当海马体，用 DGD 在线学习做会越用越准的激活层。 :: in=17 out=9 :: #AI #工程 :: cluster=C-多层有损压缩
- [[适应度幻觉]] :: 评测方式与真实目标错位时，进化产出高分但无效的解；meomory v4、MTV ARM、kaiwu 暖启动是三种子型 :: in=32 out=10 :: #AI #认知科学 #优化 :: cluster=C-适应度幻觉
- [[没有前额叶的皮层]] :: LLM 保留系统2执行能力却丢失自我监控，导致 [[知道与推测不分]]，与脑干缺失是两个独立的结构性缺陷。 :: in=16 out=8 :: #AI #认知科学 :: cluster=C-RL+LLM双系统
...
- [[研究者过拟合]] :: 研究者被早期高分锚定后失去对评测方式本身的质疑能力，AI 研究者也会犯同样的认知偏差 :: in=21 out=6 :: #认知科学 #元认知 :: cluster=C-适应度幻觉
...
- [[AI镜像效应]] :: AI 产出是用户自身想法的反射而非外部异物，长期只消费 AI 等于自我对话导致认知耗尽。 :: in=23 out=8 :: #AI #哲学 #认知科学 :: cluster=C-知道与推测不分
- [[判断力的有效梯度]] :: 判断动作只有经过事前预测、外部结果、误差归因并改变后续行为，才会转化为能力增长。 :: in=10 out=9 :: #AI #方法论 #认知科学 :: cluster=C-知道与推测不分
- [[领先指标迁移]] :: 当实现能力商品化，竞争优势会从产出速度迁移到反馈所有权、结果密度与分发位置。 :: in=9 out=8 :: #AI #方法论 #工程 :: cluster=C-知道与推测不分
- [[连续基质问题]] :: LLM 与 RL 作为分离程序通过 API 通信，缺少可被反复"磨"出来的共享神经通路，导致渐进式 [[技能编译]] 不可行。 :: in=10 out=5 :: #AI #认知科学 :: cluster=C-RL+LLM双系统
...
- [[研究核与投射]] :: 项目数 ≠ 方向数；13 个散乱仓库可能是 3-4 个研究核的不同投射，显性化核能让决策带宽降到 1/3。 :: in=7 out=10 :: #方法论 #认知科学 #AI :: cluster=C-知道与推测不分
...
- [[涌现接力]] :: 新项目需要方向、知识库、AI当场抽取、接受执行四者联合到位，缺一则不发生；乘号是助记记号不是可测量的量 :: in=14 out=11 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[当场抽取]] :: AI在协作当下生成的零件可独立判断，是[[涌现接力]]里AI唯一不可替代的真贡献 :: in=17 out=9 :: #AI #认知科学 :: cluster=C-涌现接力
- [[人工脑干]] :: 为 AI 补充不可关闭底层驱动的架构层，应是轻量确定性程序而非 LLM；具身智能中由物理约束自然提供。脑区映射是工作类比而非结构性描述。 :: in=5 out=12 :: #AI #认知科学 #工程 :: cluster=C-RL+LLM双系统
...
- [[显式化爆发]] :: 30-90分钟密集卡片化的爆发性写入才是涌现真trigger，substrate温度比厚度更关键 :: in=13 out=8 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[知识库飞轮]] :: substrate×AI×回写持续相互喂养、单调增厚、定期分泌新项目的可观测循环 :: in=12 out=8 :: #AI #方法论 #工程 :: cluster=C-涌现接力
...
- [[研究路径结晶化]] :: 一次对话从具体任务出发挖出散落项目的统一框架并自我建模——单案例命名，需更多观察验证 :: in=10 out=11 :: #AI #方法论 #认知科学 :: cluster=C-涌现接力
...
- [[substrate做梦]] :: 让 AI 离线 review substrate 做 schema 整合，对应大脑睡眠的记忆巩固——但触发是事件驱动而非时间驱动 :: in=11 out=14 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
- [[噪声鲁棒性与天花板]] :: 动量+Adam 让进化算法对反馈噪声极不敏感，但有结构性天花板，瓶颈在算法不在反馈或轮次 :: in=5 out=3 :: #AI #实验 #工程 :: cluster=C-适应度幻觉
- [[溶解与信息熵]] :: 溶解速度由上下文异分布信号比例决定而非长度，ReAct 工具调用因持续注入真实数据天然免疫。 :: in=1 out=5 :: #AI #认知科学 #实验 :: cluster=C-知道与推测不分
...
- [[共享矩阵干扰天花板]] :: 单矩阵承载多查询的关联干扰是架构级限制，所有缓解机制本质都在减少 M 的影响力 :: in=4 out=5 :: #AI #认知科学 #工程 :: cluster=C-适应度幻觉
...
- [[substrate噩梦]] :: substrate做梦的失败模式——AI 离线 review 时虚假整合、强行 bridge、被 AI 习惯范式同化 :: in=4 out=10 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[潜伏层]] :: substrate 双层结构里"已存在但未卡片化"的层（PDF/长文/对话/脑中复现），是[[显式化爆发]]的原料 :: in=2 out=11 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[级联爆发]] :: 一次显式化爆发触发下一次更上位的爆发，连续多级跳跃直到 substrate 自指——单案例命名待验证 :: in=0 out=10 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[涌现的解剖：meomory诞生考古]] :: 用git考古重建2026-03-15 meomory诞生47分钟，证伪单方涌现，提出4方接力模型 :: in=8 out=16 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[2026-07-30-AI应用开发的领先指标迁移]] :: AI应用实现能力正在商品化，个人优势必须从开发速度转向反馈所有权和可验证结果。 :: in=1 out=6 :: #AI #方法论 #工程 :: cluster=C-知道与推测不分
...
- [[substrate会做梦：从整体诊断认出记忆巩固机制]] :: 让 AI 离线 review 整个 substrate 等价于大脑睡眠的记忆巩固，飞轮缺这个 sleep phase :: in=5 out=19 :: #AI #认知科学 #方法论 :: cluster=C-涌现接力
...
- [[lens-wake首次运行-元认知循环的实例化]] :: lens 代理 + wake 记忆层第一次实际运行，意外暴露出系统真正的能力不是"记得对"，而是"能让记错被看见"——形状记忆系统升级为元认知系统。 :: in=0 out=10 :: #AI #工程 #认知科学 :: cluster=C-涌现接力
- [[事件驱动的substrate：从时间投射到反应式代谢]] :: 修正 [[substrate做梦]] 的本体论错误——substrate 不是时间性生物，触发应是事件驱动 :: in=0 out=6 :: #AI #工程 #方法论 :: cluster=C-涌现接力
- [[六面归一：5个项目其实是1个项目]] :: meomory/brainstem/minecraft-agent/Atlas/prompt-evolution/KB-Index 是同一命题"AI 缺什么 + 怎么用人类 substrate 补它"的 6 个面 :: in=0 out=17 :: #AI #方法论 #认知科学 :: cluster=C-涌现接力
...
- [[2026-04-27-kb-index-system]] :: 用Leiden聚类把知识库渲染成4个markdown，让AI入场即获地形感，触发更频繁的[[当场抽取]] :: in=10 out=10 :: #工程 #方法论 #AI :: cluster=C-涌现接力
