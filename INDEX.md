---
generated: 2026-05-03T02:43:37+0800
...
- [[多层有损压缩]] :: 意识到文本经历多层压缩，大模型只是影子的影子；遗忘是压缩代价，不是独立模块。 :: in=51 out=10 :: #AI #哲学 :: cluster=C-多层有损压缩
- [[关联记忆]] :: M(key)→value 框架统一深度学习一切组件——MLP、动量、Adam、注意力都是不同频率的关联记忆。 :: in=32 out=9 :: #AI #工程 :: cluster=C-多层有损压缩
- [[可行动状态]] :: 认知的终点不是抽象真理，而是把现实压成足以支撑下一步动作的低维内部状态。 :: in=19 out=9 :: #AI #认知科学 #哲学 :: cluster=C-多层有损压缩
...
- [[前意识激活层]] :: 在 LLM 之前放一个它看不见的匹配层，让记忆"自动浮现"而非主动检索——区分记忆与图书馆的关键。 :: in=20 out=8 :: #AI #认知科学 #工程 :: cluster=C-多层有损压缩
...
- [[AI镜像效应]] :: AI 产出是用户自身想法的反射而非外部异物，长期只消费 AI 等于自我对话导致认知耗尽。 :: in=14 out=8 :: #AI #哲学 #认知科学 :: cluster=C-描述即污染
...
- [[当场抽取]] :: AI在协作当下生成的零件可独立判断，是[[涌现接力]]里AI唯一不可替代的真贡献 :: in=16 out=9 :: #AI #认知科学 :: cluster=C-描述即污染
- [[校准的不可外包性]] :: 品味只能通过接受/拒绝AI产出累积，是[[AI镜像效应]]的对偶解，唯一不可工具化的环节 :: in=17 out=8 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
...
- [[substrate做梦]] :: 让 AI 离线 review substrate 做 schema 整合，对应大脑睡眠的记忆巩固——但触发是事件驱动而非时间驱动 :: in=10 out=14 :: #AI #认知科学 #方法论 :: cluster=C-描述即污染
- [[Vibe Coding上瘾]] :: 伪装成生产力的自我回音上瘾，比短视频更隐蔽因为产出了代码，停下来时空虚是识别信号。 :: in=3 out=5 :: #AI #认知科学 #方法论 :: cluster=C-RL+LLM双系统
- [[研究路径结晶化]] :: 一次对话从具体任务出发挖出散落项目的统一框架并自我建模——单案例命名，需更多观察验证 :: in=8 out=10 :: #AI #方法论 #认知科学 :: cluster=C-描述即污染
...
- [[失败可见性]] :: 元认知系统的成功标准——不是 recall 准确率，而是让"我刚才在幻觉/记错"这件事变成可观测、可追问、可修正的。 :: in=2 out=8 :: #AI #认知科学 #工程 :: cluster=C-描述即污染
...
- [[形状记忆系统]] :: 结构化KB全量注入长上下文模型作为记忆层，V0 部署后被首次运行重新定义为元认知系统——成功标准从 recall accuracy 转为 [[失败可见性]]。 :: in=2 out=13 :: #AI #工程 #认知科学 :: cluster=C-描述即污染
